...
def terminal_reward(
    ...
    *,
    ...
    targets = gold_answer if isinstance(gold_answer, tuple) else (gold_answer,)
    f1 = max((answer_f1(final_answer, target) for target in targets), default=0.0)
