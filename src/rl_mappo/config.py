...
class MAPPOConfig:
    ...
    max_protocol_parse_failure_rate: float = 0.05
    max_validation_missing_answer_tag_rate: float = 0.02
    min_validation_final_compliance_rate: float = 0.95
    seed: int = 42
    max_rounds: int = 4
...
def parse_args(argv: list[str] | None = None) -> MAPPOConfig:
    ...
    parser.add_argument("--max-steps", type=int, default=values["max_steps"])
